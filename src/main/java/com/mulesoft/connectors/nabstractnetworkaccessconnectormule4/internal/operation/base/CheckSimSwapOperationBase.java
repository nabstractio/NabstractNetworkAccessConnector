...
public abstract class CheckSimSwapOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/sim-swap/v0/check";
  ...
  public CheckSimSwapOperationBase() {
    super();
  }

  public CheckSimSwapOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }
  ...
  protected void checkSimSwapMain(
      RestConfiguration config,
      RestConnection connection,
      String clientIdHeader,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(checkSimSwapBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
