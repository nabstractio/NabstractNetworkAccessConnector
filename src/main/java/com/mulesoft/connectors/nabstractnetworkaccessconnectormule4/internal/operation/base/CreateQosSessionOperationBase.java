...
public abstract class CreateQosSessionOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/qod/v0/sessions";
  ...
  public CreateQosSessionOperationBase() {
    super();
  }

  public CreateQosSessionOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void createQosSession(
    ...
    try {
      ...
      createQosSessionMain(
          config,
          connection,
          customParameterBindings,
          createQosSessionBody,
          parameters,
          overrides,
          callback);
  ...
  protected void createQosSessionMain(
      RestConfiguration config,
      RestConnection connection,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .setBody(createQosSessionBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
