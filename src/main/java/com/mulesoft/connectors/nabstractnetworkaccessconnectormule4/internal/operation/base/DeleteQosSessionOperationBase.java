...
public abstract class DeleteQosSessionOperationBase extends BaseRestOperation {
  ...
  public DeleteQosSessionOperationBase() {
    super();
  }

  public DeleteQosSessionOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void deleteQosSession(
  ...
  protected void deleteQosSessionMain(
      RestConfiguration config,
      RestConnection connection,
      String sessionIdUriParam,
