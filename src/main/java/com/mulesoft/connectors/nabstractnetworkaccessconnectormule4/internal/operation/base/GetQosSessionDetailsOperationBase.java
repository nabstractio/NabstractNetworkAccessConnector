...
public abstract class GetQosSessionDetailsOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/qod/v0/sessions/{sessionId}";
  ...
  public GetQosSessionDetailsOperationBase() {
    super();
  }

  public GetQosSessionDetailsOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void getQosSessionDetails(
  ...
  protected void getQosSessionDetailsMain(
      RestConfiguration config,
      RestConnection connection,
      String sessionIdUriParam,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .addUriParam("sessionId", sessionIdUriParam);
    doRequest(
        config,
        connection,
        builder,
