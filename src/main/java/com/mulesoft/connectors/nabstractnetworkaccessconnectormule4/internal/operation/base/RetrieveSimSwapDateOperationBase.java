package com.mulesoft.connectors.nabstractnetworkaccessconnectormule4.internal.operation.base;
...
public abstract class RetrieveSimSwapDateOperationBase extends BaseRestOperation {
  protected static final String OPERATION_PATH = "/sim-swap/v0/retrieve-date";
  ...
  public RetrieveSimSwapDateOperationBase() {
    super();
  }

  public RetrieveSimSwapDateOperationBase(ExpressionLanguage arg0) {
    super(arg0);
  }

  protected void retrieveSimSwapDate(
  ...
  protected void retrieveSimSwapDateMain(
      RestConfiguration config,
      RestConnection connection,
      String clientIdHeader,
    ...
    RestRequestBuilder builder =
        getRequestBuilderWithBindings(
            ...
            .addHeader("Client-id", clientIdHeader)
            .setBody(retrieveSimSwapDateBody, overrides.getStreamingType());
    doRequest(
        config,
        connection,
        builder,
